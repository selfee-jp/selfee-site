  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    if (scrollTopButton) {
      window.addEventListener("scroll", function () {
        ...
        var currentOpacity = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.getProperty(scrollTopButton, "opacity");
...
function header() {
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var navLinks = document.querySelectorAll('.header__nav-item a');
...
function mv() {
  // タイムラインの初期化
  var openingTL = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();

  // タイトルアニメーション
  openingTL.to('.js-mv-title', {
    duration: 1,
    delay: 0.5,
    y: 0,
    autoAlpha: 1,
...
function textScroll() {
  window.addEventListener('DOMContentLoaded', function () {
    ...
    var splitTargets = document.querySelectorAll('.js-splitText');
    ...
    splitTargets.forEach(function (target) {
      ...
      spanText.split('').forEach(function (char, index) {
        if (index === 0 && target.classList.contains('js-text-effect--head')) {
          newText += "<span class=\"char heading__en-big\">".concat(char, "</span>"); // 最初の文字にクラスを追加
        } else if (index === 5 && target.classList.contains('js-text-effect--about')) {
          newText += "<span class=\"char heading__en-space\">".concat(char, "</span>"); // 6つ目の文字にクラスを追加
        } else {
          newText += "<span class=\"char\">".concat(char, "</span>");
        }
      });
      target.innerHTML = newText; // ターゲットに生成した要素を挿入
    });

    var textEffects = document.querySelectorAll('.js-text-effect'); // ターゲットとなる要素を全取得
    textEffects.forEach(function (target) {
...
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_common */ "./js/_common.js");
/* harmony import */ var _drawer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_drawer */ "./js/_drawer.js");
/* harmony import */ var _mv__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_mv */ "./js/_mv.js");
/* harmony import */ var _line__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_line */ "./js/_line.js");
...
(0,_drawer__WEBPACK_IMPORTED_MODULE_2__.drawer)();
// slide();
(0,_mv__WEBPACK_IMPORTED_MODULE_3__.mv)();
